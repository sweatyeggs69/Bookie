  ...
  const inputEl = (
    <div ref={containerRef} className="relative w-full">
      ...
      <input
        ...
        className="w-full bg-surface-raised border border-line rounded-lg pl-9 pr-9 py-2 text-sm text-ink placeholder:text-ink-muted focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/40 transition-colors"
        autoComplete="off"
        spellCheck={false}
      />
